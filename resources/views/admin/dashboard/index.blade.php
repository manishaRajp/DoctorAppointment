                    ...
                    <div class="row">
                            ...
                            <div class="card mini-stat m-b-30">
                                ...
                                <div class="card-body">
                                    <div class="border-bottom pb-4">
                                        <span class="badge badge-success"> +11% </span> <span class="ml-2 text-muted">From
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card mini-stat m-b-30">
                                ...
                                <div class="card-body">
                                    <div class="border-bottom pb-4">
                                        <span class="badge badge-success"> +22% </span> <span class="ml-2 text-muted">From
                                            previous period</span>
                                    </div>
                                    <div class="mt-4 text-muted">
                                        <div class="float-right">
                                        ...
                                        <h5 class="m-0">3567<i class="mdi mdi-arrow-up text-success ml-2"></i>
                                        </h5>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card mini-stat m-b-30">
                                ...
                                <div class="card-body">
                                    <div class="border-bottom pb-4">
                                        <span class="badge badge-danger"> -02% </span> <span class="ml-2 text-muted">From
                                            previous period</span>
                                    </div>
                                    <div class="mt-4 text-muted">
                                        <div class="float-right">
                                        ...
                                        <h5 class="m-0">14.5<i class="mdi mdi-arrow-down text-danger ml-2"></i>
                                        </h5>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card mini-stat m-b-30">
                                ...
                                <div class="card-body">
                                    <div class="border-bottom pb-4">
                                        <span class="badge badge-success"> +10% </span> <span class="ml-2 text-muted">From
                                            previous period</span>
                                    </div>
                                    <div class="mt-4 text-muted">
                                        <div class="float-right">
                                        ...
                                        <h5 class="m-0">15234<i class="mdi mdi-arrow-up text-success ml-2"></i>
                                        </h5>
                                            ...
                                            <div class="col-md-6">
                                                <div class="text-center">
                                                    <span class="peity-pie"
                                                        data-peity='{ "fill": ["#508aeb", "#f2f2f2"]}' data-width="84"
                                                        data-height="84">6/8</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div>
                                                    <div class="mb-4">
                                                        <span class="peity-donut"
                                                            ...
                                                            data-width="60" data-height="60">2,4</span>
                                                    </div>
                                                    <h4>42%</h4>
                                            ...
                                            <div class="col-6">
                                                <div>
                                                    <div class="mb-4">
                                                        <span class="peity-donut"
                                                            data-peity='{ "fill": ["#508aeb", "#f2f2f2"], "innerRadius": 22, "radius": 32 }'
                                                            data-width="60" data-height="60">8,4</span>
                                                    </div>
                                                    <h4>58%</h4>
                            ...
                            <div class="card m-b-30 blog-wid">
                                <div class="card-body">
                                    ...
                                    <div class="post-details p-2">
                                        <h6 class="mt-0"><a href="#" class="text-dark">It will be as
                                                simple as Occidental</a></h6>
                                        <p class="text-muted">Everyone realizes why a new common language would be
                                            desirable.</p>
                                        <p class="mb-0">By <a href="#" class="text-primary">Daniel Sons</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled activity-list">
                                        <li class="activity-item">
                                            ...
                                            <p class="text-muted mt-2">Everyone realizes why a new common language would
                                                be desirable common words.</p>
                                        </li>
                                        <li class="activity-item">
                                        ...
                                        <li class="activity-item">
                                            ...
                                            <p class="text-muted mt-2 mb-4">The new common language will be more simple
                                                and regular their pronunciation.</p>
                                            <div>
